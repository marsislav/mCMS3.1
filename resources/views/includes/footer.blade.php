    ...
    <div class="container">
        ...
        <div class="copyright-area">
            <div class="row align-items-center">
                ...
                <div class="col-md-6">
                    <p class="wow fadeInUp" data-wow-delay=".3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeInUp;">Разработчик: <a href="https://marsislav.net/" target="_blanks">Marsislav</a></p>
                </div>
            </div>
        </div>
    </div>
